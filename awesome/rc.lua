...
globalkeys = gears.table.join(
   ...
   -- awful.key({ modkey,           }, "w", function ()  end,
    ...
    awful.spawn.easy_async("/home/giga/.config/awesome/rofi-selector.sh", function(stdout, stderr, reason, exit_code)
...
{description = "select next", group = "layout"}),
    ...
    awful.key({ modkey, "Shift"          }, "t", function () awful.spawn("redshift -x") end,
              {description = "", group = "launcher"}),
