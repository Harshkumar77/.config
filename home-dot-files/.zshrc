...
alias z='zsh'
alias vw='tmux rename-window "notes"; nvim ~/notes/diary/diary.md -c "VimwikiDiaryGenerateLinks" -c "VimwikiMakeYesterdayDiaryNote" -c "VimwikiMakeDiaryNote" -c "e ~/notes/index.md" -c "cd ~/notes" -c "GlassToggle"'
alias l='eza --icons -a'
