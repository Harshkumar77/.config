...
alias z='zsh'
alias vw='tmux rename-window "notes"; nvim ~/notes/diary/diary.md -c "VimwikiDiaryGenerateLinks" -c "VimwikiMakeDiaryNote" -c "e ~/notes/index.md" -c "cd ~/notes" -c "GlassToggle" -c "LspStop"'
alias l='eza --icons -a'
